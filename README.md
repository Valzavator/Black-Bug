...
* [Steper motor](http://arduino-diy.com/arduino-drayver-shagovogo-dvigatelya-i-dvigatelya-postoyannogo-toka-L298N)
 ...
 <h4>Встановлення програми Fabscan</h4>
 1) Потрібно скачати образ операційної систеи із встановленим Fabscan з сайту 
 ...
 5) В налаштуваннях нажати Detect laser і вибрати Fetch frame налаштувати щоб центр платворми проходив по жовтій лінії 
